                        ...
                        >
                           ...
                           >
                              ...
                              <g id="SVGRepo_iconCarrier">
                                 {" "}
                                 <path d="M17 8v1h-17v-1h17z" fill="#000000"></path>{" "}
                              </g>
                           </svg>
                        </button>
                  ...
                  <div className="flex flex-col pt-3 pb-3">
                     ...
                     <div className="flex items-center gap-2 pl-1.5">
                        ...
                        <button
                           className={`border rounded-md transition duration-500 hover:scale-125
                           ${
                              selectedCellBorderStyle !== "double"
                                 ? "border-slate-400 bg-slate-200"
                                 : "border-slate-600 bg-slate-400"
                           }`}
                        ...
                        <button
                           className={`border rounded-md transition duration-500 hover:scale-125
                              ${
                                 selectedCellBorderStyle !== "dashed"
                                    ? "border-slate-400 bg-slate-200"
                                    : "border-slate-600 bg-slate-400"
                              }`}
                        ...
                        <button
                           className={`border border-slate-400 rounded-md bg-slate-200 transition duration-500 hover:scale-125
                              ${
                                 selectedCellBorderStyle !== "dotted"
                                    ? "border-slate-400 bg-slate-200"
                                    : "border-slate-600 bg-slate-400"
                              }`}
                  ...
                  <div className="flex flex-col pt-3 pb-3">
                        ...
                        >
                           ...
                           >
                              ...
                              <g id="SVGRepo_iconCarrier">
                                 {" "}
                                 <rect width="16" height="16" id="icon-bound" fill="none"></rect>{" "}
                                 <path d="M3,13l10,0l0,2l-10,0l0,-2Zm8,-12l2,0l0,6c0,2.76 -2.24,5 -5,5c-2.76,0 -5,-2.24 -5,-5l0,-6l2,0l-0,6c-0,1.656 1.344,3 3,3c1.656,0 3,-1.344 3,-3l0,-6Z"></path>{" "}
                              </g>
                           </svg>
                        </button>
                     ...
                     <div className="flex items-center gap-1.5">
                        ...
                        <button
                           className={`border rounded-md transition duration-500 hover:scale-125 py-1
                              ${
                                 selectedCellTextJustify !== "center"
                                    ? "border-slate-400 bg-slate-200"
                                    : "border-slate-600 bg-slate-400"
                              }`}
