...
Graph.prototype.toSVG = function (callback: Export.ToSVGCallback, options?: Export.ToSVGOptions) {
...
Graph.prototype.toPNG = function (callback: Export.ToSVGCallback, options?: Export.ToImageOptions) {
   const instance = this.getPlugin("export") as Export;
   if (instance) {
...
Graph.prototype.toJPEG = function (callback: Export.ToSVGCallback, options?: Export.ToImageOptions) {
   const instance = this.getPlugin("export") as Export;
   if (instance) {
...
Graph.prototype.exportPNG = function (fileName?: string, options?: Export.ToImageOptions) {
   const instance = this.getPlugin("export") as Export;
   if (instance) {
...
Graph.prototype.exportJPEG = function (fileName?: string, options?: Export.ToImageOptions) {
   const instance = this.getPlugin("export") as Export;
   if (instance) {
...
Graph.prototype.exportSVG = function (fileName?: string, options?: Export.ToSVGOptions) {
   const instance = this.getPlugin("export") as Export;
   if (instance) {
