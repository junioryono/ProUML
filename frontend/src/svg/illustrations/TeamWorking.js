...
const TeamWorking = ({ width = 164, height = 101 }) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="none" viewBox="0 0 164 101">
      <path
        fill="#E6E6E6"
      ...
      <path fill="#CE8172" d="M140.805 12.67a3.176 3.176 0 001.425-1.11s.13 1.585-1.41 3.36l-.015-2.25z" opacity="0.31"></path>
      <path
        fill="#FFD200"
      ...
      <path fill={colorPrimaryMain} d="M19.235 13.855l3.035.645s13.9 1.5 14.465 9.34c.565 7.84-7.29 27.89-7.29 27.89H8.385S-8.5 11.785 19.235 13.855z"></path>
      <path
        fill="#E6E6E6"
      ...
      ></path>
      <path fill="#68E1FD" d="M8.105 16.56C5 18.947.335 24.21.425 34.15l12.755.816S16.865 24.05 13 17.5a3.325 3.325 0 00-4.895-.94z"></path>
      <path fill={colorPrimaryMain} d="M8.105 16.56C5 18.947.335 24.21.425 34.15l12.755.816S16.865 24.05 13 17.5a3.325 3.325 0 00-4.895-.94z" opacity="0.36"></path>
      <path
        fill="#F4A28C"
