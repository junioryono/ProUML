  ...
  return (
    <Box>
      ...
      <Box maxWidth={600} margin={"0 auto"}>
        ...
        >
          <Box display="flex" flexDirection={{ xs: "column", md: "row" }} alignItems={{ xs: "center", md: "flex-start" }} justifyContent={{ xs: "center" }}>
            <Box
              flex={"1 1 auto"}
              component={TextField}
            ...
            />
            <Box component={Button} variant="contained" color="primary" size="large" height={54} marginTop={{ xs: 2, md: 0 }} marginLeft={{ md: 2 }}>
              Request a demo
            </Box>
          </Box>
        </Box>
