    ...
    <Box>
      <Container>
        <Box marginBottom={4}>
          ...
          <Typography gutterBottom>There 3 types of layouts used in the theme:</Typography>
          <ul>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} md={4}>
              <Box display={"flex"} flexDirection={"row"}>
                <Box marginRight={1} color={alpha(theme.palette.primary.main, 0.4)}>
                ...
                <Box>
                  ...
                  <Typography>
                    ...
                    <Link underline="hover" href="/landing-software-company" target={"_blank"}>
                      here
                    </Link>
                    .
                  </Typography>
            ...
            <Grid item xs={12} md={4}>
              <Box display={"flex"} flexDirection={"row"}>
                ...
                <Box>
                  ...
                  <Typography>
                    A usage example of the Fluid layout can be found{" "}
                    <Link underline="hover" href="/page-signup" target={"_blank"}>
                      here
                    </Link>
                    .
                  </Typography>
            ...
            <Grid item xs={12} md={4}>
              <Box display={"flex"} flexDirection={"row"}>
                ...
                <Box>
                  ...
                  <Typography>
                    A usage example of the Fluid layout can be found{" "}
                    <Link underline="hover" href="/docs-introduction" target={"_blank"}>
                      here
                    </Link>
                    .
                  </Typography>
