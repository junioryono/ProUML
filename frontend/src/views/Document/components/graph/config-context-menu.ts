import type { NsNodeCmd, NsEdgeCmd, IMenuOptions, NsGraph, IArgsBase, HookHub, ICmdHooks as IHooks } from "@antv/xflow";
...
export const useContextMenuConfig = createCtxMenuConfig((config) => {
