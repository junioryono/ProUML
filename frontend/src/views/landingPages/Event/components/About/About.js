    ...
    <Box>
      <Box marginBottom={{ xs: 4, sm: 8, md: 12 }}>
        ...
        <Typography variant={"h6"} component={"p"} color={"textSecondary"} align={"center"} data-aos="fade-up">
          ...
          <br />
          but the majority have suffered alteration in some form, by ected humour, or randomised words whi.rere arge many variations ohf passages of sorem gpsum ilable.
        </Typography>
      </Box>
      <Grid container spacing={4} direction={isMd ? "row" : "column-reverse"}>
        ...
        <Grid item container justifyContent="center" alignItems="center" xs={12} md={6} data-aos={isMd ? "fade-left" : "fade-up"}>
          <Box component={Card} boxShadow={4} height={"100%"} width={"100%"}>
            <Box component={CardMedia} height={"100%"} width={"100%"} minHeight={300} image="https://assets.maccarianagency.com/backgrounds/img20.jpg" />
          </Box>
        </Grid>
      </Grid>
    </Box>
