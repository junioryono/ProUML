        ...
        <Box component={CardContent} padding={{ sm: 4 }}>
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} sm={6}>
              ...
              >
                <Box marginBottom={4}>
                  <Box component={Typography} fontWeight={600} variant={"h6"} gutterBottom>
                    A better way to Expand.
                    <br />
                    Globally.
                  </Box>
                  <Typography>We make it simple to hire, onboard, and pay your global workforce in 150+ countries in full compliance with local laws.</Typography>
                </Box>
