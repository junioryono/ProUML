      ...
      <Grid container spacing={4}>
        {[
          ...
          <Grid item xs={12} md={4} key={i}>
            <Box component={Card} height={"100%"} display={"flex"} flexDirection={"column"} boxShadow={item.isHighlighted ? 4 : 0}>
              ...
              <Box flexGrow={1} />
              <Box component={CardActions} justifyContent={"flex-start"} padding={4}>
