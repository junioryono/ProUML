...
const Reviews = () => {
  ...
  const GridItemHeadlineBlock = () => (
    <Box>
      ...
      <Box component={Typography} fontWeight={700} variant={"h3"} gutterBottom data-aos={"fade-up"}>
        Don't take word for it
      </Box>
      <Typography variant={"h6"} component={"p"} color={"textSecondary"} data-aos={"fade-up"}>
