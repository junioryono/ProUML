        ...
        <Grid container spacing={4}>
          {[
            ...
            },
            {
              ...
              subtitle: "We continually deploy improvements and new updates to Webbee.",
              icon: (
                <svg height={24} width={24} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path
                    strokeLinecap="round"
            ...
            <Grid item xs={12} sm={6} md={4} key={i}>
              <Box component={Card} padding={4} borderRadius={4} width={"100%"} height={"100%"} data-aos={"fade-up"}>
                <Box display={"flex"} flexDirection={"column"}>
                  ...
                  <Box component={Typography} variant={"h6"} gutterBottom sx={{ fontWeight: 500 }} color={"currentColor"}>
                    {item.title}
                  </Box>
